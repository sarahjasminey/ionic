...
export class RegformPage implements OnInit {
  ...
  year:any;
    ...
    this.route.queryParams.subscribe(params => {
      if (this.router.getCurrentNavigation().extras.queryParams) {
        this.champtype = this.router.getCurrentNavigation().extras.queryParams.type;  
        this.champid = this.router.getCurrentNavigation().extras.queryParams.id;
      }
      else{
          //alert('no id'); 
          this.champid =29;       
  ...
  uploadaadhar(str:any)
  {
    ...
    console.log(formData,this.aadharimage);
     this.http.post("https://teddiapp.com/app/api/ionic_champ/champ_upload_aadhar",formData)
 .subscribe((data:any)=>{
       console.log(data);
     })
  ...
  uploadpan(str:any)
  {
    ...
    console.log(formData,this.panimage);
     this.http.post("https://teddiapp.com/app/api/ionic_champ/champ_upload_pan",formData)
 .subscribe((data:any)=>{
       console.log(data);
     })
